...
<List strong inset outline class="no-margin-bottom">
  <ListItem title={$_("statistics.expense-income-difference")} after={expenseIncomeDiff} />
  <ListItem title={$_("statistics.invoice-refund-difference")} after={invoiceRefundDiff} />
  <ListItem title={"Profit"} after={combinedDiff} footer={$_("profit.helper")} />
</List>
